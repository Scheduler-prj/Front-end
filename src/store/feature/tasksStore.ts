...
const dummyTasks: Task[] = [
    { todoId: 1, title: "리액트 공부하기", todoAt: "2/6", color: "#FF5733", planAlarm: true, planComment: "", completed: false },
    { todoId: 2, title: "운동하기", todoAt: "2/6", color: "#33FF57", planAlarm: false, planComment: "", completed: true },
    { todoId: 3, title: "독서 30분 하기", todoAt: "2/6", color: "#5733FF", planAlarm: true, planComment: "", completed: false },
];
